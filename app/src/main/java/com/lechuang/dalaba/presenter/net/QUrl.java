package com.lechuang.dalaba.presenter.net;

import com.lechuang.dalaba.BuildConfig;
...
public interface QUrl {
    ...
    //正式
    String url = BuildConfig.QUrl_url;
//    String url = "http://gouwubang.lechuangapp.com/";

    //测试
    //String url = "http://192.168.1.100:8889/";
    ...
    * */
    ...
    //微信登录接口
    String wxToken_ID = "sns/oauth2/access_token";
    String wxGetUserInro = "sns/userinfo";
