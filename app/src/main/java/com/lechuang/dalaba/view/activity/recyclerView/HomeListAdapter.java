...
public class HomeListAdapter extends RecyclerView.Adapter<HomeListAdapter.MyViewHolder> {
    ...
    public HomeListAdapter(List<HomeLastProgramBean.ListBean> productList, Context context, int code) {
        data = productList;
        mContext = context;
        isAgencyStatus = code;
    }
    ...
    public HomeListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_last_program_list, parent, false);
        HomeListAdapter.MyViewHolder vh = new HomeListAdapter.MyViewHolder(view);
        return vh;
    }
...
//        holder.tvGet.setText("赚 ¥ " + bean.zhuanMoney);
    ...
    private HomeGridAdapter.OnItemClickLitener mOnItemClickLitener;

    public void setOnItemClickLitener(HomeGridAdapter.OnItemClickLitener mOnItemClickLitener) {
