...
public class SpannelTextViewNew extends View {
    ...
    public SpannelTextViewNew(Context context) {
        this(context, null);
    }

    public SpannelTextViewNew(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SpannelTextViewNew(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
